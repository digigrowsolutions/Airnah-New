...
import { resetCustomization, updateTotalCost } from '../../redux/ringCustomizationSlice';
...
const StepThree = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-start gap-2  ">      {/* Left Side - Image Grid */}
      ...
      {/* Right Side - Content */}
      <div className="w-full md:w-2/5 border border-[#bf927f] p-8 space-y-4 flex flex-col max-h-fit">
        ...
        <div className="text-2xl font-light text-green-900">
          ${productDetails[0].ring?.ring_price + productDetails[0].diamond?.diamond_price}
