                ...
                <div className="absolute left-0 right-0 top-180 w-screen bg-white shadow-md py-4 z-50 flex justify-center">
                  <div className="max-w-7xl w-full grid grid-cols-3 gap-6 px-6">
                    {item.submenu.map((category, catIndex) => (
                      <div key={catIndex}>
                        <h3 className="text-gray-900 font-semibold mb-2">{category.heading}</h3>
            ...
            <div key={index} className="text-gray-700 hover:text-gray-900 font-medium">
              ...
              {item.submenu.length > 0 && (
                <div className="space-y-2">
                  {item.submenu.map((category, catIndex) => (
                    <div key={catIndex}>
                      <h3 className="text-gray-900 font-semibold">{category.heading}</h3>
                      <ul className="space-y-1">
                        {category.items.map((subitem, subIndex) => (
                          <li key={subIndex} className="text-gray-700 hover:text-gray-900">
                            {subitem}
                          </li>
                        ))}
                      </ul>
