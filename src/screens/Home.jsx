  ...
  return (
    <div>
      ...
      <section className="relative w-full h-[100vh]">
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          {slides.map((slide, index) => (
            <div
              key={index}
              className={`absolute inset-0 w-full h-full transition-all duration-500 ease-in-out ${currentSlide === index ? "opacity-100" : "opacity-0"
                }`}
              style={{
      ...
      >
        ...
        <div className="md:w-1/2 flex flex-col justify-center p-10" style={{ margin: "auto" }}>
          <h2 className="text-3xl font-bold text-gray-800 text-center">The Brilliance of Diamonds</h2>
          <p className="mt-4 text-gray-600 text-center">
            Diamonds are formed under intense heat and pressure deep within the Earth’s crust.
            Their unmatched hardness and brilliant sparkle make them the most coveted gemstones.
          </p>
          <p className="mt-2 text-gray-600 text-center">
            Did you know? The largest diamond ever found, the Cullinan Diamond, weighed an astonishing 3,106 carats!
          </p>
      ...
      <div className="relative w-full max-w-4xl mx-auto p-4">
        ...
        <div className="swiper-button-prev absolute top-1/2 left-2 z-10 transform -translate-y-1/2 p-2 rounded-full bg-white shadow-lg cursor-pointer hover:bg-gray-200 transition">
          <ChevronLeft className="text-gray-600 hover:text-gray-900" size={16} />
        </div>
        ...
        <div className="swiper-button-next absolute top-1/2 right-2 z-10 transform -translate-y-1/2 p-2 rounded-full bg-white shadow-lg cursor-pointer hover:bg-gray-200 transition">
          <ChevronRight className="text-gray-600 hover:text-gray-900" size={16} />
        </div>
      </div>
        ...
        <div className="max-w-6xl w-full">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="relative flex-1">
              <img src="/path-to-image.jpg" alt="Jewelry" className="w-full h-full object-cover rounded-xl shadow-lg" />
              <div className="absolute bottom-4 left-4 bg-white bg-opacity-80 p-4 rounded-lg shadow-md">
                <p className="text-gray-700 text-lg font-semibold">Exquisite craftsmanship in every detail.</p>
              </div>
            </div>
            <div className="relative flex-1">
              <img src="/path-to-image2.jpg" alt="Jewelry" className="w-full h-full object-cover rounded-xl shadow-lg" />
              <div className="absolute bottom-4 left-4 bg-white bg-opacity-80 p-4 rounded-lg shadow-md">
                <p className="text-gray-700 text-lg font-semibold">Timeless elegance for every occasion.</p>
              </div>
            </div>
          </div>
        </div>
